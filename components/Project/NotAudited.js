      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <h1 className="text-xl font-semibold dark:text-white">Code Audit History</h1>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-4">
          <div>
            <div className="flex items-center justify-between bg-yellow-500/10 p-4 rounded">
              <div className="text-sm dark:text-white">Codeum Audit</div>
          ...
          <div>
            <div className="flex flex-col gap-3 rounded p-4 bg-emerald-900/20 dark:bg-emerald-900/30 shadow">
              <div className="flex items-center justify-between gap-2">
                <div className="text-sm dark:text-white">Codeum Automatic Audit</div>
                <div className="flex flex-col items-end flex-grow">
                  <div className="text-2xl font-semibold dark:text-white">Yes</div>
                </div>
              </div>
            </div>
          </div>
